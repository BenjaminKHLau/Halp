  ...
  return (
    <form className="business-form" onSubmit={subby}>
      ...
      <div className="add-info-label">
        <label>
          Add information about your business below. Your business page will not
          appear in search results until this information has been verified and
      ...
      <div className="form-css">
        <div className="form-box">
          ...
          <div className="middle-div">
            ...
            <label className="form-stuff">
              Category
              <div className="business_form_category_container">
                <select
                  className="form-input"
                  type="text"
                  name="category"
